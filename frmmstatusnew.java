...
public class frmmstatusnew extends JFrame
{
		...
		String str1,str2;
	    int allowance,salary,netsalary;
		...
		public frmmstatusnew()
	{
		...
		b2.addActionListener(new netsalaryListener());
		b2.setToolTipText("Click to calculate netsalary");
	...
	private class allowanceListener implements ActionListener
	   ...
	   public void actionPerformed(ActionEvent e)
			...
			//mstatus=Integer.parseInt(str2);
			 if(str1.compareTo("married")==0)
				allowance=1500;
				else
				{
					if(str1.compareTo("unmarried")==0)
						allowance=1000;
				else
				{
					if(str1.compareTo("divorse")==0)
					     allowance=800;
				else
				 {
				     if(str1.compareTo("widow")==0)
					      allowance=1200;
				}
				}
				}
		
			str1=Integer.toString(allowance);
			t5.setText(str1);
			
			}
        }
		
		private class netsalaryListener implements ActionListener
       {
	   ...
	   public void actionPerformed(ActionEvent e)
			...
			allowance=Integer.parseInt(str2);
			netsalary=salary+allowance;
			str1=Integer.toString(netsalary);
			t6.setText(str1);
